    ...
    <div>
        <form action="post">
            ...
            <div class="form-group">
                ...
                <select name="order_status_name" id="order_status_name" v-model="statuses.order_status_name" class="form-control">
            ...
            <div class="form-group">
                ...
                <select name="order_payment_name" id="order_payment_name" v-model="payments.order_status_name" class="form-control">
                    <option disabled value="">Выберите статус</option>
            ...
            <div class="form-group">
                ...
                <select name="order_client_id" v-model="clients.order_client_id" class="form-control">
                    <option disabled value="">Выберите статус</option>
               ...
               <div class="card col-lg-5" v-if="isVisible" v-for="(product, k) in order.products" :key="k">
                   <div class="card-body " >
                       ...
                       <div class="form-group" >
                           ...
                           <input type="text" class="form-control" v-model="order.products[k].product_name" name="product_name" placeholder="Номер">
                       </div>
    ...
    export default {
        ...
        data() {
            return{
                order:{
                    order_name:'12',
                    order_date:'2020-08-20',
                    order_status_id: 1,
                    order_payment_id: 1,
                    order_sum: 20300,
                    order_shipment_date:'2020-08-21',
                    order_client_id: 2 ,
                    order_manager_id: 1,
                    products:[{
                        product_name:'12313',
